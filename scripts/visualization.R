#This code is for visiualization of summary statistics for ossicle and petrous libraries
...
# Cropping map data
maplimits <- c(25,46,35,43)
nat.crop <- raster::stack(crop(raster50, y=extent(maplimits)))
